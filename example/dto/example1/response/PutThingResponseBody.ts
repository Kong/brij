...
export type PutThingResponseBody = SharedObj1

class PutThingResponseBodySchema extends JSONSchema {
  constructor() {
    super({
      "title": "SharedObj1",
      "type": "object",
...
export const PutThingResponseBody = new PutThingResponseBodySchema()
