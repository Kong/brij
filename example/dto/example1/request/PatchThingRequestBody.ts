...
export type PatchThingRequestBody = SharedObj1

class PatchThingRequestBodySchema extends JSONSchema {
  constructor() {
    super({
      "title": "SharedObj1",
      "type": "object",
...
export const PatchThingRequestBody = new PatchThingRequestBodySchema()
